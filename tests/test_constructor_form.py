...
class TestStellarBurgersConstructorForm:
    def test_constructor_go_to_sauces_scroll_to_sauces(self, login):
        ...
        assert driver.find_element(*locators.locator_sauces_button).get_attribute('class') == 'tab_tab__1SPyG tab_tab_type_current__2BEPc pt-4 pr-10 pb-4 pl-10 noselect'
    ...
    def test_constructor_go_to_bun_scroll_to_bun(self, login):
        ...
        assert driver.find_element(*locators.locator_sauces_ban).get_attribute('class') == 'tab_tab__1SPyG tab_tab_type_current__2BEPc pt-4 pr-10 pb-4 pl-10 noselect'
    ...
    def test_constructor_go_to_filling_scroll_to_filling(self, login):
        ...
        assert driver.find_element(*locators.locator_sauces_filling).get_attribute('class') == 'tab_tab__1SPyG tab_tab_type_current__2BEPc pt-4 pr-10 pb-4 pl-10 noselect'
